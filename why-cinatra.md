...
See [Registry and marketplace](admin/marketplace.md).
...
See [Creating agents in chat](user/creating-agents-in-chat.md).
...
See [Continuous learning and custom skills](user/continuous-learning.md).
...
See [Cross-instance collaboration](user/cross-instance-collaboration.md).
...
- The platform vocabulary: [Concepts and glossary](user/concepts.md)
- The hands-on tour: [Quickstart](hosting/quickstart.md)
- A guided tour of the workspace: [Workspace features](user/workspace-features.md)
