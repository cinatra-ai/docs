...
- The runtime that hosts the primitives at the application layer: [Architecture](../developer/architecture.md)
- The open standards the MCP server speaks alongside MCP itself: [Open standards in Cinatra](../developer/open-standards.md)
- The configuration surface for the MCP server: [Configuration](../hosting/configuration.md)
