...
For the definitions behind these terms, see [Concepts and glossary](concepts.md#extension).
...
- [Concepts and glossary](concepts.md#extension) — the precise meaning of agent, connector, skill, artifact, and workflow
