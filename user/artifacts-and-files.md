...
- Developer reference: [Artifacts architecture](../developer/artifacts.md) and [LLM attachments and prompt-window upload](../developer/artifacts-attachments-and-prompt-window-upload.md) for the mechanics
