...
For the Cinatra side of the marketplace, the [Admin Guide](../configuration/README.md) walks through the general administration model.
...
- The protocol-level reference for the integration: [Integrating Cinatra with a CMS](../developer/integrating-with-a-cms.md) in the Developer Guide
