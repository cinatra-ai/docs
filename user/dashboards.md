...
- The architecture of the dashboards subsystem: [Architecture](../developer/architecture.md)
- The objects model the cubes query over: [Objects layer](../developer/objects-layer.md)
- The generic permissions story dashboards share with other extensions: [Security](../developer/security.md)
- The MCP surface dashboards register against: [The external MCP server](../mcp/external-server.md)
- The implementation behind this page: [Dashboards platform](../developer/dashboards-platform.md)
