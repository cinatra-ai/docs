...
[Project scoping](../developer/project-scoping.md).
...
- [Concepts and glossary](concepts.md) — agents, skills, objects, lists, teams, organizations
- [Artifacts and files](artifacts-and-files.md) — the outputs that get scoped to a Project
- Developer reference: [Project scoping](../developer/project-scoping.md) — the access model, sealed-room reads, and the full data model
