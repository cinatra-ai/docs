...
For the full injection rules, provider-by-provider tool handling, and the JWT exchange behind native MCP, see [LLM orchestration](../developer/llm-orchestration.md).
...
- The orchestration internals and MCP injection rules: [LLM orchestration](../developer/llm-orchestration.md)
