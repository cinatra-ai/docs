...
- [Extensions reference](../developer/extensions.md) — developer implementation details for building and activating extensions
- [Extension lifecycle](../developer/extension-lifecycle.md) — the installed-state model and lifecycle transitions
- [Security](../developer/security.md) — the per-resource access model and the audit trail
