...
If you are arriving here from the README, this page is the map. If you are looking for the developer reference, start at [Concepts and glossary](../../references/glossary.md).
...
Discover and install extensions from your connected registries. Public extensions are visible to every Cinatra instance; private extensions are filtered server-side to the publishing instance's vendor scope. See [Marketplace](../admin/marketplace.md).

### Extensions (`/configuration/extensions`)

The active / archived catalog of every extension installed in this instance, with the lifecycle controls (archive, restore, force-delete, promote to public) and the GitHub-release skill upload entry at `/configuration/extensions/upload`. See [Marketplace](../admin/marketplace.md) for the install flows and [Extensions](../../references/platform/extensions.md) for the engineering shape.

### Permissions (`/configuration/permissions`)

Platform roles, organisation membership, and the generic Extension Permissions surface used across all four extension kinds (agents, skill extensions, dashboards, dashboard cubes). Skill extensions additionally support per-skill overrides. See [Security](../../references/platform/security.md).
...
- The open protocols every sidebar surface speaks: [Open standards in Cinatra](../../references/platform/open-standards.md)
- The architecture behind the sidebar: [Architecture](../../references/platform/architecture.md)
