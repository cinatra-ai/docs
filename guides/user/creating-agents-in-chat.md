...
- How the produced package reaches other instances: [Registry and marketplace](../admin/marketplace.md)
- The open standards a chat-authored agent automatically speaks: [Open standards in Cinatra](../../references/platform/open-standards.md)
