...
For the protocol details (the full `AgentCard` shape, how the bearer JWT is verified, the route flag matrix), see [Cross-instance collaboration](../../references/platform/cross-instance-collaboration.md) in the Developer Guide.
...
- The protocol-level details: [Cross-instance collaboration](../../references/platform/cross-instance-collaboration.md) in the Developer Guide
- The marketplace experience: [Marketplace](../admin/marketplace.md)
- The open standards Cinatra speaks: [Open standards in Cinatra](../../references/platform/open-standards.md)
- Permissions on installed extensions: [Security](../../references/platform/security.md)
