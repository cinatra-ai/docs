...
`docs/developer/artifacts.md` for the platform-level model.
...
- `docs/developer/artifacts.md` — platform-level data model
- `docs/developer/context-slots.md` — how `contextSlots` consume your extension
