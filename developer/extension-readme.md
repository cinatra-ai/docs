...
The shape is the same for every kind. The content interpretation differs per kind. The gate at [`scripts/audit/extension-readme-gate.mjs`](../../scripts/audit/extension-readme-gate.mjs) enforces the structure. Wired in CI by [`extension-readme-gate.yml`](../../.github/workflows/extension-readme-gate.yml).
...
- [Building TypeScript packages for extensions](./building-packages.md)
- [Extension lifecycle and distribution](./extension-lifecycle.md)
- [`scripts/audit/extension-readme-gate.mjs`](../../scripts/audit/extension-readme-gate.mjs) — the gate
- [`.github/workflows/extension-readme-gate.yml`](../../.github/workflows/extension-readme-gate.yml) — CI
