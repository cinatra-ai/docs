...
[`feedback_drizzle_cube_pitfalls.md`](../../.claude/memory/feedback_drizzle_cube_pitfalls.md) (user memory) catalogues seven traps invisible to typecheck + unit tests:
...
- [`docs/developer/cube-schemas.md`](./cube-schemas.md) — TBD; how to author a new cube.
- [`docs/developer/llm-orchestration.md`](./llm-orchestration.md) — where AI generation hooks in.
