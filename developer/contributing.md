...
For security issues, do not open a public issue. See [Security](security.md#reporting-vulnerabilities) for the private disclosure path.
...
- Email for private security disclosure ([Security](security.md))
