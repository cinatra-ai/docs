...
[Undo and history](../user/undo-and-history.md); this page covers the data
...
- [Developer Guide overview](README.md)
...
- [Objects: the canonical surface](objects.md) — the unified object model and
  its primitives
- [Undo and history](../user/undo-and-history.md) — the user-facing walkthrough
