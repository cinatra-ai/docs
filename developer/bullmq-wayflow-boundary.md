...
- `docs/developer/llm-orchestration.md` — orchestration layer that stays TypeScript.
- `docs/developer/mcp-patterns.md` — MCP primitive conventions used by both TypeScript
  and runtime layers.
- `docs/developer/agent-development.md` — authoring new agents.
