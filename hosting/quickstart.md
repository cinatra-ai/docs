...
See [Open standards in Cinatra](../developer/open-standards.md) for the full breakdown.
...
- Review the full configuration surface for non-default setups: [Configuration](../hosting/configuration.md)
