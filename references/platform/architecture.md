...
- Build an agent: [Developing agents](../../guides/developer/developing-agents.md)
- Package one up: [Building packages](../../guides/developer/building-packages.md)
- Understand the standards: [Open standards in Cinatra](open-standards.md)
- Configure the platform: [Configuration](../../guides/hosting/configuration.md)
