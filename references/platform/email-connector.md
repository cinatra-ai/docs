...
Documents the `@cinatra-ai/email-connector` subsystem. Read alongside `mcp-patterns.md`, `llm-orchestration.md`, and `references/platform/extensions.md` (the `kind:"connector"` extension kind).
