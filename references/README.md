...
Stable specifications, contracts, architecture, and protocol references — the "how it actually works" material the [guides](../guides/README.md) build on. These are reference documents, not step-by-step tutorials.
