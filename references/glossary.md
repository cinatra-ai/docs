...
For a deeper architectural picture, see [Architecture](platform/architecture.md). For the open standards that meet at the platform's edges, see [Open standards in Cinatra](platform/open-standards.md).
...
The declarative file format Cinatra agents are authored in. Cinatra implements `agentspec_version: "26.1.0"`. See [Open standards in Cinatra](platform/open-standards.md).
...
- See how the pieces fit: [Architecture](platform/architecture.md)
- Author your first agent: [Developing agents](../guides/developer/developing-agents.md)
- Install and run an agent: [Quickstart](../guides/hosting/quickstart.md)
- The open standards behind the surfaces: [Open standards in Cinatra](platform/open-standards.md)
- Extension lifecycle: [Extensions](platform/extensions.md)
